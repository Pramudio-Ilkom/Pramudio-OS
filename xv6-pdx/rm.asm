...
printint(int fd, int xx, int base, int sgn)
{
 ...
 411:	0f b6 92 50 07 00 00 	movzbl 0x750(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 562:	75 28                	jne    58c <printf+0x12e>
          s = "(null)";
 564:	be 49 07 00 00       	mov    $0x749,%esi
...
free(void *ap)
{
 ...
 5db:	a1 58 0a 00 00       	mov    0xa58,%eax
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 58 0a 00 00       	mov    %eax,0xa58
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 676:	e8 50 ff ff ff       	call   5cb <free>
  return freep;
 67b:	a1 58 0a 00 00       	mov    0xa58,%eax
...
malloc(uint nbytes)
{
 ...
 6a3:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 6a6:	8b 0d 58 0a 00 00    	mov    0xa58,%ecx
 ...
 6b2:	eb 4b                	jmp    6ff <malloc+0x70>
    base.s.ptr = freep = prevp = &base;
 6b4:	c7 05 58 0a 00 00 5c 	movl   $0xa5c,0xa58
 6bb:	0a 00 00 
 6be:	c7 05 5c 0a 00 00 5c 	movl   $0xa5c,0xa5c
 6c5:	0a 00 00 
    base.s.size = 0;
 6c8:	c7 05 60 0a 00 00 00 	movl   $0x0,0xa60
 6cf:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 6d2:	b9 5c 0a 00 00       	mov    $0xa5c,%ecx
 ...
 6e3:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6e6:	89 0d 58 0a 00 00    	mov    %ecx,0xa58
      return (void*)(p + 1);
 ...
 704:	73 d3                	jae    6d9 <malloc+0x4a>
    if(p == freep)
 706:	39 05 58 0a 00 00    	cmp    %eax,0xa58
